  ...
  return (
    <footer className="border-t border-vortex-border bg-white py-8 px-4 font-mono mt-16">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
        ...
        {/* Left Brand Title (Logo removed) */}
        <div>
          <span className="font-heading font-extrabold text-sm text-black tracking-wider block">
            VORTEX PROTOCOL
          </span>
        ...
        <div className="text-xs text-gray-500 text-center">
          <div>VORTEX ENGINE v1.0.0 // STUDIONET DEPLOYMENT ACTIVE</div>
